<script setup lang="ts">
	...
	const pageConfig = CLONE((useState('pages').value as any).page);
	...
	<div>
		...
		<v-window v-model="tab">
			<v-window-item value="search">
				<Form v-if="configs?.cmp_page_search_form" :config="configs?.cmp_page_search_form" @submit="onSubmit" />
			...
			<v-window-item value="create">
				<Form v-if="configs?.cmp_page_create_form" :config="configs?.cmp_page_create_form" @submit="onSubmit" />
			</v-window-item>
		</v-window>
	</div>
</template>
