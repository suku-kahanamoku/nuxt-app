...
<template>
	<v-btn v-if="open" color="warning" class="my-1" @click="open = !open">{{ $t('settings.warn') }}</v-btn>
	<v-btn v-else outline="warning" class="my-1" @click="open = !open">{{ $t('settings.warn') }}</v-btn>
